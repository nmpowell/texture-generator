...
| Porosity class | Ring-porous oak/ash put 2–4 rows of coarse vessels in a band at each ring start, and **that band is a fixed 0.5–1.5 mm regardless of ring width** — a wide ring means more latewood, not a wider pore band. Semi-ring-porous walnut/cherry taper over 30–60 % of the ring; diffuse-porous maple/sapele/mahogany are uniform. **`pine` has no vessels at all**, and that absence is what makes a softwood read as a softwood |
